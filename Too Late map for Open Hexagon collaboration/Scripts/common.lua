...
function rWallThick(mSide, THICKNESS)
	...
	wall(mSide + getHalfSides(), THICKNESS)
end
...
function cWallExThick(mSide, mExtra, mThick)
	...
	if mExtra < 0 then loopDir = -1 end
	for i = 0, mExtra, loopDir do wall(mSide+i, mThick) end
end
...
-- cBarrage2: spawns a barrage of walls, with two free mSide
function cBarrage2(mSide) cBarrageN(mSide, 0.1) end

function cBarrageThick2(mSide, mThick) cBarrageNThick(mSide, 0.1, mThick) end

-- cBarrage3: spawns a barrage of walls, with three free mSide
function cBarrage3(mSide) cBarrageN(mSide, 1) end

function cBarrageThick3(mSide, mThick) cBarrageNThick(mSide, 1, mThick) end

-- cBarrage4: spawns a barrage of walls, with four free mSide
function cBarrage4(mSide) cBarrageN(mSide, 1.1) end

function cBarrageThick4(mSide, mThick) cBarrageNThick(mSide, 1.1, mThick) end
